...
public class CertUtil {
    ...
    public static void extractAttestationSequence(X509Certificate x509Certificate, SoterPubKeyModel soterPubKeyModel) throws Exception {
        ...
        SLogger.i(TAG, "soter: challenge json in attestation certificate ".concat(str), new Object[0]);
