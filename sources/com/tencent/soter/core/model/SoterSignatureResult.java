...
public class SoterSignatureResult {
    ...
    public SoterSignatureResult(String str, String str2, long j, String str3, String str4, String str5, String str6, String str7, String str8, int i) {
        this.jsonValue = "";
        this.rawValue = str;
        this.fid = str2;
        this.counter = j;
    ...
    public static SoterSignatureResult convertFromJson(String str) {
        try {
            ...
            SLogger.e(TAG, "soter: convert from json failed." + e.toString(), new Object[0]);
            return null;
        }
    }
