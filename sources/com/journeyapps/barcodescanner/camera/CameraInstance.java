...
public class CameraInstance {
    ...
    /* synthetic */ void m384xdd5ef35b(boolean z) {
    ...
    public void changeCameraParameters(final CameraParametersCallback cameraParametersCallback) {
        ...
        if (this.open) {
            this.cameraThread.enqueue(new Runnable() { // from class: com.journeyapps.barcodescanner.camera.CameraInstance$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m381x78173d15(cameraParametersCallback);
                }
            });
        }
    }
    ...
    /* synthetic */ void m381x78173d15(CameraParametersCallback cameraParametersCallback) {
    ...
    /* synthetic */ void m383xf1e80099(final PreviewCallback previewCallback) {
        if (!this.open) {
            ...
            this.cameraThread.enqueue(new Runnable() { // from class: com.journeyapps.barcodescanner.camera.CameraInstance$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m382xd7cc81fa(previewCallback);
                }
            });
        }
    }
    ...
    /* synthetic */ void m382xd7cc81fa(PreviewCallback previewCallback) {
