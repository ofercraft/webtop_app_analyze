...
public abstract class AbstractExpandedDecoder {
    ...
    public static AbstractExpandedDecoder createDecoder(BitArray bitArray) {
        ...
        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(bitArray, 1, 7)) {
            case Miui3DFaceManagerImpl.MSG_ENROLL_ERROR_TEMLATE_FILE_NOT_EXIST /* 56 */:
                return new AI013x0x1xDecoder(bitArray, "310", "11");
            case Miui3DFaceManagerImpl.MSG_ENROLL_ERROR_DISABLE_FAIL /* 57 */:
                return new AI013x0x1xDecoder(bitArray, "320", "11");
            case Miui3DFaceManagerImpl.MSG_ENROLL_ERROR_NOT_SAME_PERSON /* 58 */:
                return new AI013x0x1xDecoder(bitArray, "310", "13");
            case Miui3DFaceManagerImpl.MSG_ENROLL_ERROR_SDK_ERROR /* 59 */:
            ...
            case Miui3DFaceManagerImpl.MSG_ENROLL_ERROR_FACE_LOST /* 62 */:
