    ...
    private class ColumnMap extends Maps.ViewCachingAbstractMap<C, Map<R, V>> {
        ...
        private final class ColumnMapEntrySet extends StandardTable<R, C, V>.TableSet<Map.Entry<C, Map<R, V>>> {
            ...
            public Iterator<Map.Entry<C, Map<R, V>>> iterator() {
                ...
                final StandardTable standardTable = StandardTable.this;
                Objects.requireNonNull(standardTable);
                return Maps.asMapEntryIterator(setColumnKeySet, new Function() { // from class: com.google.common.collect.StandardTable$ColumnMap$ColumnMapEntrySet$$ExternalSyntheticLambda0
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
