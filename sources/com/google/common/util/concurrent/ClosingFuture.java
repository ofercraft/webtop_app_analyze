...
public final class ClosingFuture<V> {
    ...
    public static <V, U> AsyncClosingFunction<V, U> withoutCloser(final AsyncFunction<V, U> function) {
        ...
        return new AsyncClosingFunction() { // from class: com.google.common.util.concurrent.ClosingFuture$$ExternalSyntheticLambda3
            ...
            public final ClosingFuture apply(ClosingFuture.DeferredCloser deferredCloser, Object obj) {
                return ClosingFuture.from(function.apply(obj));
            }
        };
    }
    ...
    static /* synthetic */ void lambda$closeQuietly$0(AutoCloseable autoCloseable) {
        try {
            TypefaceCompat$$ExternalSyntheticBackport0.m52m((Object) autoCloseable);
        } catch (Exception e) {
    ...
    private boolean compareAndUpdateState(State oldState, State newState) {
        return AtomicReference$$ExternalSyntheticBackportWithForwarding0.m(this.state, oldState, newState);
    }
