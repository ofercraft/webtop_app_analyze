    ...
    private static final class ServiceManagerState {
        ...
        ImmutableMap<Service, Long> startupTimes() {
            ...
            try {
                ...
                this.monitor.leave();
                Collections.sort(arrayListNewArrayListWithCapacity, Ordering.natural().onResultOf(new Function() { // from class: com.google.common.util.concurrent.ServiceManager$ServiceManagerState$$ExternalSyntheticLambda0
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
        ...
        void transitionService(Service service, Service.State from, Service.State to) throws Exception {
