...
public final class Hashing {
    ...
    private static class Md5Holder {
        static final HashFunction MD5 = new MessageDigestHashFunction(KeyPropertiesCompact.DIGEST_MD5, "Hashing.md5()");
    ...
    private static class Sha1Holder {
        static final HashFunction SHA_1 = new MessageDigestHashFunction(KeyPropertiesCompact.DIGEST_SHA1, "Hashing.sha1()");
    ...
    private static class Sha256Holder {
        static final HashFunction SHA_256 = new MessageDigestHashFunction(KeyPropertiesCompact.DIGEST_SHA256, "Hashing.sha256()");
    ...
    private static class Sha384Holder {
        static final HashFunction SHA_384 = new MessageDigestHashFunction(KeyPropertiesCompact.DIGEST_SHA384, "Hashing.sha384()");
    ...
    private static class Sha512Holder {
        static final HashFunction SHA_512 = new MessageDigestHashFunction(KeyPropertiesCompact.DIGEST_SHA512, "Hashing.sha512()");
    ...
    public static HashFunction hmacSha1(Key key) {
        return new MacHashFunction(KeyPropertiesCompact.KEY_ALGORITHM_HMAC_SHA1, key, hmacToString("hmacSha1", key));
    }

    public static HashFunction hmacSha1(byte[] key) {
        return hmacSha1(new SecretKeySpec((byte[]) Preconditions.checkNotNull(key), KeyPropertiesCompact.KEY_ALGORITHM_HMAC_SHA1));
    }

    public static HashFunction hmacSha256(Key key) {
        return new MacHashFunction(KeyPropertiesCompact.KEY_ALGORITHM_HMAC_SHA256, key, hmacToString("hmacSha256", key));
    }

    public static HashFunction hmacSha256(byte[] key) {
        return hmacSha256(new SecretKeySpec((byte[]) Preconditions.checkNotNull(key), KeyPropertiesCompact.KEY_ALGORITHM_HMAC_SHA256));
    }

    public static HashFunction hmacSha512(Key key) {
        return new MacHashFunction(KeyPropertiesCompact.KEY_ALGORITHM_HMAC_SHA512, key, hmacToString("hmacSha512", key));
    }

    public static HashFunction hmacSha512(byte[] key) {
        return hmacSha512(new SecretKeySpec((byte[]) Preconditions.checkNotNull(key), KeyPropertiesCompact.KEY_ALGORITHM_HMAC_SHA512));
    }
